...
class AssistantUI:
    ...
    def __init__(self, root):
        ...
        self.launch_ios10_btn = ttk.Button(launch_frame, text='iOS10 iPad', 
                                            command=lambda: self.launch_with_mode('ios10'))
        self.launch_ios10_btn.grid(row=0, column=1, sticky='ew', padx=2)
        
        self.launch_android8_btn = ttk.Button(launch_frame, text='Android8 Chrome67', 
                                              command=lambda: self.launch_with_mode('android8'))
        self.launch_android8_btn.grid(row=0, column=2, sticky='ew', padx=2)
        
        self.launch_chrome60_btn = ttk.Button(launch_frame, text='Chrome60 Desktop', 
                                               command=lambda: self.launch_with_mode('chrome60'))
        self.launch_chrome60_btn.grid(row=0, column=3, sticky='ew', padx=2)
        
        self.launch_chrome70_btn = ttk.Button(launch_frame, text='Chrome70 Desktop', 
                                               command=lambda: self.launch_with_mode('chrome70'))
        self.launch_chrome70_btn.grid(row=0, column=4, sticky='ew', padx=2)
    ...
    def _on_browser_ready(self):
        ...
        self.launch_ios10_btn.config(state='disabled')
        self.launch_android8_btn.config(state='disabled')
        self.launch_chrome60_btn.config(state='disabled')
