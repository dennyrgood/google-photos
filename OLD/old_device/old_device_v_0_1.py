...
class BrowserController:
    ...
    def _worker_main(self, headful):
        ...
        try:
            ...
            # Strategy: Use a slightly older but still supported mobile browser
            # iOS 12 iPad is old enough to get simpler UI but new enough to not be blocked
            # You can experiment with different user agents by changing this variable
            
            # Option 1: iOS 12 iPad (recommended - gets simpler mobile UI)
            ...
            # Option 2: Old Android Chrome (alternative)
            ...
            # Option 3: iOS 11 iPhone (more mobile-optimized)
            # user_agent = 'Mozilla/5.0 (iPhone; CPU iPhone OS 11_0 like Mac OS X) AppleWebKit/604.1.38 (KHTML, like Gecko) Version/11.0 Mobile/15A372 Safari/604.1'
            
            # Option 4: Desktop with older Chrome (simpler than latest, but desktop layout)
            ...
            self.context = self.playwright.chromium.launch_persistent_context(
                ...
                viewport={'width': 1024, 'height': 768},  # iPad 2 landscape resolution
